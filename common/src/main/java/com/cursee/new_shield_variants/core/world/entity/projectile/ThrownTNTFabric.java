...
public class ThrownTNTFabric extends ThrowableItemProjectile {
    ...
    public ThrownTNTFabric(EntityType<? extends ThrowableItemProjectile> p_37473_, Level p_37474_) {
        super(p_37473_, p_37474_);
    }

    public ThrownTNTFabric(Level p_37481_, LivingEntity p_37482_) {
        super(ModEntities.THROWN_TNT, p_37482_, p_37481_);
        setItem(Items.TNT.getDefaultInstance());
        this.setItemSlot(EquipmentSlot.MAINHAND, Items.TNT.getDefaultInstance());
        if (Services.PLATFORM.isDevelopmentEnvironment()) System.out.println("created ThrownTNTFabric instance");
    }

    public ThrownTNTFabric(Level p_37476_, double p_37477_, double p_37478_, double p_37479_) {
        super(ModEntities.THROWN_TNT, p_37477_, p_37478_, p_37479_, p_37476_);
    }
